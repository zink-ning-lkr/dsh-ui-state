 ...
 * on the host settings seam, and mounts a loopback-only HTTP bridge
 * (describe + mutate) so the browser client can persist and restore the
 * official sidebar layout. Same pattern as dsh-node-nav / dsh-chat-width.
 */
